...
dotenv.config();
const mongoDBMDP = process.env.MONGODB_MDP


// Connexion à la base de données
mongoose.connect(`mongodb+srv://theocottin:${mongoDBMDP}@monvieuxgrimoire.92fc45b.mongodb.net/?retryWrites=true&w=majority`,
